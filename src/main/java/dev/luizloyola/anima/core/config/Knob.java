...
public enum Knob implements KnobSpec {
    ...
    /** @see dev.luizloyola.anima.core.brain.Arbiter#stickiness() */
    ...
    /** @see dev.luizloyola.anima.core.brain.Arbiter#preempt() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.FleeInstinct#range() */
    FLEE_RANGE("instincts.flee_range", Kind.DOUBLE, 16.0, 1.0, 64.0,
            "Distance (blocks) at which a threat starts to register at all."),
    /** @see dev.luizloyola.anima.core.brain.instinct.FleeInstinct#ramp() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.FleeInstinct#rangedRangeMult() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.FleeInstinct#approachBonus() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.DescendInstinct#pressure() */
    ...
    /** @see dev.luizloyola.anima.core.brain.knowledge.CrescentSampler#radius() */
    ...
    /** @see dev.luizloyola.anima.core.brain.knowledge.RegionGrowth#maxSpread() */
     ...
     * {@link dev.luizloyola.anima.core.agent.AgentProfile#CONFIGURED} — the fallback for a body
     * that declares nothing about itself.
     *
     * @see dev.luizloyola.anima.core.agent.AgentProfile#perceptionRadius()
     */
    PEERS_RADIUS("peers.radius", Kind.INT, 24, 4, 64,
            "How far (blocks) another person can be perceived at all."),
    /** @see dev.luizloyola.anima.core.agent.AgentProfile#sneakRangeMult() */
    ...
    /** @see dev.luizloyola.anima.core.agent.AgentProfile#coneDegrees() */
    ...
    /** @see dev.luizloyola.anima.core.agent.AgentProfile#verticalHalfDegrees() */
    ...
    /** @see dev.luizloyola.anima.core.brain.sense.BeingSensorCore#lingerTicks() */
    ...
    /** @see dev.luizloyola.anima.core.brain.sense.BeingSensorCore#heardActivityDecayTicks() */
    ...
    /** @see dev.luizloyola.anima.core.brain.sense.BeingSensorCore#nearIntervalTicks() */
    ...
    /** @see dev.luizloyola.anima.core.brain.sense.BeingSensorCore#farIntervalTicks() */
    ...
    /** @see dev.luizloyola.anima.core.brain.sense.BeingSensorCore#herdLinkRadius() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.Danger#meleeMult() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.Danger#rangedMult() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.Danger#armoredMult() */
    DANGER_ARMORED_MULT("danger.armored_mult", Kind.DOUBLE, 1.2, 0.0, 4.0,
            "Danger multiplier for visible armor on the body."),
    /** @see dev.luizloyola.anima.core.brain.instinct.Danger#mountedMult() */
    ...
    /** @see dev.luizloyola.anima.core.brain.instinct.Danger#babyMult() */
